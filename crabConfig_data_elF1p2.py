...
config.General.requestName = 'Data_elF1p2'
...
config.JobType.scriptExe = 'execute_iheartNY_dataG_el.sh'

config.section_("Data")
config.Data.inputDataset = '/SingleElectron/vorobiev-SingleElectron_Run2016F-23Sep2016-v1_B2GAnaFW_80X_v2p4-e26b2444814d18badce3899570108664/USER'
