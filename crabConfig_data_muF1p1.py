...
config.General.requestName = 'Data_muF1p1'
...
config.JobType.scriptExe = 'execute_iheartNY_dataEF_mu.sh'

config.section_("Data")
config.Data.inputDataset = '/SingleMuon/vorobiev-Run2016F-23Sep2016-v1_B2GAnaFW_80X_v2p4-e26b2444814d18badce3899570108664/USER'
