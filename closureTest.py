...
if options.type == "full":
    f_ttbar     = TFile("histfiles/hists_PowhegPythia8_fullTruth_"+muOrEl+"_nom.root")
else :
    f_ttbar     = TFile("histfiles/hists_PowhegPythia8_fullTruth_"+muOrEl+"_nom_even.root")
    f_ttbar_odd = TFile("histfiles/hists_PowhegPythia8_fullTruth_"+muOrEl+"_nom_odd.root")
