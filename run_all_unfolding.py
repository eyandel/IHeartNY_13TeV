...
if options.closureTests:
    path = [
        ...
        #"python closureTestTUnfold_v2.py --lepType=muon --type=full --toy=nom --regType=LCurve",
        #"python closureTestTUnfold_v2.py --lepType=ele --type=full --toy=nom --regType=LCurve",
