...
void runMakeHists(TString toMake = "prefit"){
  ...
  if (toMake == "all" || toMake == "prefit" || toMake == "postfit"){
    ...
    //run data
    makeHists("skimTrees_80X/","histfiles_80X","Data_mu","mu",true,false,"Medium","MiniIso10",true,35.0,true,false,"nom",0,false);
    makeHists("skimTrees_80X/","histfiles_80X","Data_el","el",true,false,"Tight","MiniIso10",true,35.0,true,false,"nom",0,false);
    
    makeHists("skimTrees_80X/","histfiles_80X","Data_mu","mu",true,false,"Medium","MiniIso10",true,35.0,true,true,"nom",0,false);
    ...
    for (int ii = 0; ii < 1; ii++){
      ...
      //run other MCs
      for (int jj = 0; jj < 19; jj ++){
	makeHists("skimTrees_80X/","histfiles_80X",bkgMCnames[jj],"mu",false,false,"Medium","MiniIso10",true,35.0,true,false,sysnames[ii],0,postTopTagSF);
	...
	makeHists("skimTrees_80X/","histfiles_80X",bkgMCnames[jj],"mu",false,false,"Medium","MiniIso10",true,35.0,true,true,sysnames[ii],0,postTopTagSF);
