...
config.General.requestName = 'Data_elB2'
...
config.JobType.scriptExe = 'execute_iheartNY_dataBCD_el.sh'

config.section_("Data")
config.Data.inputDataset = '/SingleElectron/vorobiev-SingleElectron_Run2016B-23Sep2016-v2_B2GAnaFW_80X_v2p4-6f92d8e9b2717da1daa65a0e07f84d5f/USER'
