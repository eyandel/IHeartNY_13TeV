...
config.General.requestName = 'Data_elH3'
...
config.JobType.scriptExe = 'execute_iheartNY_dataH_el.sh'

config.section_("Data")
config.Data.inputDataset = '/SingleElectron/vorobiev-SingleElectron_Run2016H-PromptReco-v3_B2GAnaFW_80X_v2p4-376a23645e94877b22a7f32873431514/USER'
